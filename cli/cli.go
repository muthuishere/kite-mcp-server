...
case "quotes":
return runInstrumentsScoped(args[1:], stderr, func(client *kiteconnect.Client, instruments []string) (any, error) { return client.GetQuote(instruments...) })
case "ltp":
return runInstrumentsScoped(args[1:], stderr, func(client *kiteconnect.Client, instruments []string) (any, error) { return client.GetLTP(instruments...) })
case "ohlc":
return runInstrumentsScoped(args[1:], stderr, func(client *kiteconnect.Client, instruments []string) (any, error) { return client.GetOHLC(instruments...) })
